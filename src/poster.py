...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(
            self,
            text="NATIONAL EDUCATION POLICY",
        ...
        label1 = tk.Label(
            self,
            text="The National Education Policy is a",
        ...
        label2 = tk.Label(
            self,
            text="comprehensive framework for education in India.",
            font=("Helvetica Neue", 17, "bold"),
            bg="#6393a6",
        )
        ...
        label3 = tk.Label(
            self,
            text="The policy was last revised in 2020,",
            font=("Helvetica Neue", 17, "bold"),
            bg="#6393a6",
        )
        ...
        label4 = tk.Label(
            self,
            text="it seeks to transform the Indian education system.",
            font=("Helvetica Neue", 17, "bold"),
            bg="#6393a6",
        )
        ...
        bg_canvas = tk.Canvas(
            self, width=1700, height=415, background="#6393a6", highlightthickness=0
        )
        bg_canvas.place(x=-10, y=470)

        canvas = tk.Canvas(
            self, width=1700, height=190, background="#6393a6", highlightthickness=0
        )
        ...
        canvas.create_rectangle(
            73, 78, 103, 90, width=2, fill="#4C4C47", outline="#4C4C47"
        )
        ...
        canvas.create_rectangle(
            73, 45, 103, 55, width=2, fill="#4C4C47", outline="#4C4C47"
        )
        ...
        canvas.create_rectangle(
            60, 91, 260, 153, width=2, fill="#C13230", outline="#C13230"
        )
        canvas.create_oval(45, 90, 80, 153, width=3, fill="#A52A28", outline="#C13230")

        canvas.create_rectangle(
            200, 50, 300, 153, width=2, fill="#183A58", outline="#183A58"
        )
        canvas.create_rectangle(
            190, 91, 200, 153, width=2, fill="#A52A28", outline="#A52A28"
        )
        canvas.create_rectangle(
            60, 115, 190, 115, width=5, fill="#A52A28", outline="#A52A28"
        )

        # Black cap
        canvas.create_rectangle(190, 30, 310, 58, width=2, fill="#183A58")
        canvas.create_polygon(
            165, 22, 245, 8, 330, 22, 255, 40, fill="white", outline="white"
        )
        ...
        def wheel(x1, y1, x2, y2):
            ...
            canvas.create_oval(
                x1 + 3, y1 + 3, x2 - 3, y2 - 3, width=3, outline="#A62929"
            )
        ...
        def compartment(x_1, x_2):
            ...
            canvas.create_oval(
                x_1, 50, x_2, 75, width=3, fill="#183A58", outline="#183A58"
            )

            x_1 += 6
            x_2 -= 5
            canvas.create_rectangle(
                x_1, 70, x_2, 150, width=2, fill="#C13230", outline=""
            )

            x_1 -= 6
            x_2 += 5
            canvas.create_rectangle(
                x_1, 65, x_2, 75, width=2, fill="#183A58", outline="#183A58"
            )

            canvas.create_rectangle(
                x_1, 145, x_2, 155, width=3, fill="#183A58", outline="#183A58"
            )
            ...
            x_2 -= 15
            canvas.create_rectangle(
                x_1, 157, x_2, 174, width=2, fill="#4C4C47", outline=""
            )

            x_1 -= 10
            x_2 += 10
            canvas.create_rectangle(
                x_1, 162, x_2, 170, width=2, fill="#4C4C47", outline=""
            )
        ...
        def resize_image(e):
            ...
            info = [
                [
                    ImageTk.PhotoImage(Image.open("assets/welcome_1.png")),
                    "NAMASTE",
                    "Let's take a close view on the\nFeatures of NEP.",
                ],
                [
                    ImageTk.PhotoImage(Image.open("assets/access_edu_1.png")),
                    "ACCESS TO EDUCATION",
                ...
                [
                    ImageTk.PhotoImage(Image.open("assets/curriculum_1.png")),
                ...
                [
                    ImageTk.PhotoImage(Image.open("assets/teacher_1.png")),
                    "TEACHER DEVELOPMENT",
                ...
                [
                    ImageTk.PhotoImage(Image.open("assets/evaluation_1.png")),
                ...
                [
                    ImageTk.PhotoImage(Image.open("assets/resource_1.png")),
                    "RESOURCE ALLOCATION",
