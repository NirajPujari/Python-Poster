...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # load the image
        bg = ImageTk.PhotoImage(file="assets/tricolor.png")
        ...
        img = ImageTk.PhotoImage(Image.open("assets/emblem3.png"))
        ...
        def resize_image(e):
            ...
            image = Image.open("assets/tricolor.png")
            # Load an image in the script
            img = ImageTk.PhotoImage(Image.open("assets/emblem3.png"))
            img2 = ImageTk.PhotoImage(Image.open("assets/chakra1.png"))
            namaste_img = ImageTk.PhotoImage(Image.open("assets/namaste_2.png"))
            ...
            a = canvas.create_text(
                765, 490, text="", font=("Times New Roman", 44, "bold")
            )
